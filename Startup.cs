    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddIdentity<AppUser, IdentityRole>(identityOption =>
            {
                ...
                identityOption.Password.RequiredUniqueChars = 3;
            ...
            (TokenOptions.DefaultProvider).AddEntityFrameworkStores<AppDbContext>().AddDefaultTokenProviders();
        }
